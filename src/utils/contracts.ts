...
const HASHCOIN_ADDRESS = "0x81814Cd2EC975eAc745578066963DE4f8A7De293";
...
const GEMFUN_ADDRESS = "0x9A961648729eBCC2aa5388f6ddf391Fc64FDb542";
const TEST_HASH_FAUCET_ADDRESS = "0x071bfB5a1e56215Ba23Dcf23955f89065436a7D4";

import gemfunAbi from "@/lib/abi/gemfun.json";
import testHashFaucetAbi from "@/lib/abi/test-hash-faucet.json";
...
export const contractGemFun = getContract({
  client,
  chain,
  address: GEMFUN_ADDRESS,
  abi: gemfunAbi as any as Abi,
});

export const testHashFaucetContract = getContract({
  client,
  chain,
  address: TEST_HASH_FAUCET_ADDRESS,
  abi: testHashFaucetAbi as any as Abi,
});
