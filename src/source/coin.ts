const p = {
   ...
   subtitle: "A breakdown of the tokenomics of the Mining Hash project.",
   p1: {
      title: "General Information",
      list: [
         { title: "Total Supply:", val: "10 billion HASH" },
         { title: "Token Name:", val: "Hash Coin" },
{ title: "Thirdweb:", val: "https://thirdweb.com/thirdweb.eth/TokenERC20/5.0.1 Audit Report" },
      ],
   ...
   p2: {
      ...
      list: [
         ...
         {
            title: ["Mining Pool"],
            val: "NFT inventory has a limited quantity and varying rates of HASH token mining. More details are available on the main page."
         },
      ],
   ...
   p3: {
      ...
      list: [
         ...
         "Currently held in the team reserve address. Unused tokens may be sent to the Staking Contract or to the investment contract for the OTC buyback of HASH tokens."
      ],
      contact: { title: "Storage address", val: "0xD93c0D7AF1Af07b227dDC841d2146C3FDF7D98CD" }
   },
   p4: {
      title: "Community Development (Rewards)",
      subtitle: "5% (500 million tokens)",
      list: [
         "Interaction with influencers, bloggers, and rewarding project ambassadors. Rewards for participating in various quests and completing valuable tasks.",
         "Currently held in the team reserve address. Unused tokens may be sent to the Staking Contract."
      ],
      contact: { title: "Community Address", val: "0xa45B36062b50cDE45F9dc72f6Ea805AaE0b3F21c" }
   },
   p5: {
      ...
      contact: { title: "Team Address", val: "0xD9cefBFf9dFA7aE9438D1FC227982048af270e2d" }
   },
   p6: {
